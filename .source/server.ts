...
export const docs = await create.docs("docs", "content/docs", {}, {"index.mdx": __fd_glob_0, "components/flip-button.mdx": __fd_glob_1, "components/hello-world.mdx": __fd_glob_2, "components/index.mdx": __fd_glob_3, });